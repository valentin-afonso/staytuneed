  ...
  return (
    <Drawer open={open}>
      <DrawerTrigger asChild onClick={() => setOpen(true)}>
        <div className=" flex justify-between items-center mt-12 mb-28 mx-auto w-[576px] max-w-full bg-white shadow-light border-gray-border rounded-full py-2 px-5 pr-4 cursor-pointer">
