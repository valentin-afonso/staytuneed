  ...
  return (
    <Drawer open={open}>
      <DrawerTrigger asChild onClick={() => setOpen(true)}>
        <div className="searchbar_trigger relative flex justify-between items-center mx-auto w-[576px] max-w-full bg-white shadow-light hover:shadow-md border border-gray-border rounded-full py-2 px-5 pr-4 cursor-pointer">
